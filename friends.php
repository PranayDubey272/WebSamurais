...
<body>
    <div class="user-list">
        ...
        $userArray = array();
        $query = "SELECT * FROM users WHERE username <> '$username' AND id NOT IN (SELECT receiver_id FROM friend_requests WHERE sender_id = '$userId')";
                ...
                <tbody>
                    <?php foreach ($userArray as $user): ?>
                        ...
                        <img class="animeGif" src="user.png" alt="Anime GIF" data-src="?>"  onerror="src='user.png'">
                            ...
                            <td><a href="send_request.php?id=<?php echo $user['id']; ?>">Send Friend Request</a></td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
